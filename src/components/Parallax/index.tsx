...
const Parallax = () => {
  ...
  return (
    <div className={s.root}>
      <div className={s.smallPokeBall} style={{ transform: `translate(${screenX * 0.009}px, ${screenY * 0.009}px)` }}>
      ...
      <div className={s.pokeBall} style={{ transform: `translate(${screenX * 0.01}px, ${screenY * 0.01}px)` }}>
        <img src={PokeBallPng} alt="Big PokeBall" />
      </div>
      <div className={s.pikachu} style={{ transform: `translate(${screenX * -0.01}px, ${screenY * 0.05}px)` }}>
